                  ...
                  <tr key = {item.id} >
                    ...
                    <td>
                      <div className = 'buttons'>
                        <button className = 'button is-info is-small' onClick = {() => toggleEventAttendance}></button>
                        <button className = 'button is-danger is-small' onClick = {() => deleteEventAttendee}></button>
                      </div>
                    </td>
                  </tr>
                ))
